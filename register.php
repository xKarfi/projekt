    ...
    <div id="container">
        ...
        <div class="content-login">
            <div id="border-register">
                <h1>Sign up</h1>
                <form method="POST">
                    <i class="fas fa-envelope-square"></i><input type="text" id="e-mail" name="e-mail" placeholder="E-mail">
                    ...
                    <i class="fas fa-lock" style="position: absolute; left: 610px; top: 486px;"></i><input type="password" id="cpassword" name="cpassword" placeholder="Confirm password">
